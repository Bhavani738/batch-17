...
ROOT_URLCONF = 'predicting_hourly_boarding_demand.urls'
...
WSGI_APPLICATION = 'predicting_hourly_boarding_demand.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'predicting_hourly_boarding_demand',
        'USER': 'root',
        'PASSWORD': 'bhavani80966',
        'HOST': '127.0.0.1',
        'PORT': '3306',
        'OPTIONS': {
